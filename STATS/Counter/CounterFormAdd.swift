            ...
            VStack {
                ...
                Form {
                    ...
                    .simultaneousGesture(
                        TapGesture()
                            .onEnded { _ in
                                CounterStat.addCounter(interval: interval, reminders: reminders, name: name, created: created, desc: desc, icon: icon, chosenCategory: chosenCategory, modelContext: modelContext)
                                dismiss()
